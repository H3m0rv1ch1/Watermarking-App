        ...
        <div className="text-center space-y-8">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-blue-500 rounded-3xl blur-2xl opacity-30 animate-pulse"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto mt-12">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Process multiple images at once</p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
              <div className="text-4xl mb-3">🎨</div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Customizable</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Full control over watermark style</p>
            </div>
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
              <div className="text-4xl mb-3">🌍</div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Multi-Language</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Available in 7 languages</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
            <button
              ...
              className="group px-8 py-4 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-semibold text-lg shadow-lg shadow-blue-500/30 transition-all hover:scale-105 flex items-center gap-2"
            >
              Get Started
            ...
            <a
              ...
              className="px-8 py-4 bg-gray-800 dark:bg-gray-700 hover:bg-gray-900 dark:hover:bg-gray-600 text-white rounded-xl font-semibold text-lg shadow-lg transition-all hover:scale-105 flex items-center gap-2"
            >
